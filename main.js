...
global.channelLink = "https://whatsapp.com/channel/0029VbC6VbVK5cDIYTAVx50Y";
global.ytch = "𝐌|𝐒𒁂VΣ᳄ФM𒀭 ÐΞV⊹ 𝗧𝗘𝗖𝗛";
    ...
    try {
        ...
        if (message.message?.buttonsResponseMessage) {
            ...
            if (buttonId === 'channel') {
                ...
                await sock.sendMessage(chatId, {
                    text: `🔗 *Support*\nhttps://whatsapp.com/channel/0029VbC6VbVK5cDIYTAVx50Y`
                }, { quoted: message });
                return;
            }
        }

        // Unwrap ephemeral/view-once message wrappers so commands always work
        ...
        const userMessage = (
            ...
            msgContent?.buttonsResponseMessage?.selectedButtonId?.trim() ||
            ''
